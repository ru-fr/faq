Скопировано из https://github.com/ru-de/faq и адаптировано для Франции :flag-fr:    

# Жизнь Франции

В этом репозитории собрана полезная информация о жизни во Франции, главным образом в Париже: руководства, советы, ответы на часто задаваемые вопросы. Основная первоначальная аудитория: айтишники (программисты, sysops и т.д.), переехавшие во Францию работать по программе Blue Card из СНГ.
